...
export default function EngineRoute() {
    ...
    const [activeLayers, setActiveLayers] = React.useState({ entities: true, sectors: true, risks: true, events: true });
    ...
    const renderEngine = (code, extraProps = {}) => {
        ...
        switch (code) {
            ...
            case 'NUM': return <NumberologyView {...p} />;
            case 'VC': return <VantageCapitalView {...p} />;
            case 'INCP': return <INCPView {...p} />;
            case 'INV': return <INVView {...p} />;
            case 'WPV': return <WPVView {...p} />;
            case 'MINT': return <MINTView {...p} />;
            case 'ROAM': return <ROAMView {...p} />;
            case 'BB': return <BuddyBuddyView {...p} />;
            case 'NBR': return <NeighborsView {...p} />;
