...
import DevelopersProgram from "./app/routes/DevelopersProgram.jsx";
import DeveloperAuth from "./app/routes/DeveloperAuth.jsx";
...
import NSHaloLanding from "./app/routes/NSHaloLanding.jsx";
    ...
    <>
      ...
      <Routes>
        <Route element={<AppShell />}>
          ...
          <Route path="developers" element={<DevelopersProgram />} />
          <Route path="developers/access" element={<DeveloperAuth />} />
          <Route path="ns-halo-landing" element={<NSHaloLanding />} />
