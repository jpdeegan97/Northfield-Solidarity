...
import { Mic, Square, Play, Pause, Save, FileText, Clock, Archive, MoreHorizontal, CheckCircle, CloudUpload, AlertCircle } from 'lucide-react';
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-12 relative">
                        ...
                        {sessionState === 'PROCESSING' && (
                            <div className="text-center">
                                <CloudUpload size={64} className="text-orange-500 animate-bounce mx-auto mb-6" />
