...
By aligning problems with the physics best suited to address them, NS OS remains coherent in the face of increasing complexity — regardless of how the underlying hardware evolves.`
    ...
    {
        id: 'vision',
        title: '004 - Vision & Principles',
        content: `# 004 — Vision and Principles
...
This substrate gives all of them the same thing: **probabilistic compute as a service**, with clean provenance.`
    ...
    {
        id: 'abi',
        title: '005 - Probabilistic Primitives & ABI',
        content: `# 005 — Probabilistic Primitives and ABI
...
- keep engine code stable`
    ...
    {
        id: 'hcg',
        title: '006 - Heterogeneous Compute Graph',
        content: `# 006 — Heterogeneous Compute Graph (HCG)
...
Do not cache raw samples unless policy allows (could leak sensitive inference results).`
    ...
    {
        id: 'scheduler',
        title: '007 - Scheduler & QoS',
        content: `# 007 — Scheduler and QoS
...
- \`ConstraintInfeasible\` -> produce an “infeasible” result with explanation rather than crash`
    ...
    {
        id: 'tsu',
        title: '008 - TSU Device Model & Backends',
        content: `# 008 — TSU Device Model and Backends
...
Tier selection is QoS-dependent.`
    },
    {
        id: 'prs',
        title: '009 - PRS API',
        content: `# 009 — Probabilistic Runtime Service (PRS) API
...
- keep old ABI adapters available`
    ...
    {
        id: 'integration',
        title: '010 - Engine Integration Map',
        content: `# 010 — Engine Integration Map (Northfield Solidarity)
...
- probabilistic anomaly detection / uncertain record linkage`
    ...
    {
        id: 'observability',
        title: '011 - Observability, Audit & Governance',
        content: `# 011 — Observability, Audit, and Governance
...
- regression harnesses (statistical tests, not bitwise)`
    ...
    {
        id: 'security',
        title: '012 - Security, Isolation & Safety',
        content: `# 012 — Security, Isolation, and Safety
...
- per-risk-class budgets`
    ...
    {
        id: 'roadmap',
        title: '013 - MVP Roadmap',
        content: `# 013 — MVP Roadmap (Simulation-first → TSU backend later)
...
- Naming is flexible; the important thing is the contract surfaces and invariants.`
    ...
    {
        id: 'references',
        title: '015 - References',
        content: `# 015 — References
