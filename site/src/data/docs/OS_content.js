...
export const NS_OS_004_VISION = `# 004 — Vision and Principles
...
export const NS_OS_005_ABI = `# 005 — Probabilistic Primitives and ABI
...
export const NS_OS_006_HCG = `# 006 — Heterogeneous Compute Graph (HCG)
...
export const NS_OS_007_SCHEDULER = `# 007 — Scheduler and QoS
...
export const NS_OS_008_TSU = `# 008 — TSU Device Model and Backends
...
export const NS_OS_009_PRS = `# 009 — Probabilistic Runtime Service (PRS) API
...
export const NS_OS_010_INTEGRATION = `# 010 — Engine Integration Map (Northfield Solidarity)
...
export const NS_OS_011_OBSERVABILITY = `# 011 — Observability, Audit, and Governance
...
export const NS_OS_012_SECURITY = `# 012 — Security, Isolation, and Safety
...
export const NS_OS_013_ROADMAP = `# 013 — MVP Roadmap (Simulation-first → TSU backend later)
...
export const NS_OS_014_GLOSSARY = `# 014 — Glossary
...
export const NS_OS_015_REFERENCES = `# 015 — References
